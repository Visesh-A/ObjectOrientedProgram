...
namespace ObjectOrientedProgram.CommercialDataProcessing
{
    public class StockAccount
    {
        ...
        private void SaveFileUser(List<StockData> list)
        {
            ...
            File.WriteAllText(@"C:\Users\VISESH\Documents\bl excercise\ObjectOrientedProgram\ObjectOrientedProgram\StockAccount\StockData.cs", str);
            ReadStockFile(@"C:\Users\VISESH\Documents\bl excercise\ObjectOrientedProgram\ObjectOrientedProgram\StockAccount\StockData.cs");
        }

        private void SaveFileStock(List<StockData> list)
        {
            string str = JsonConvert.SerializeObject(list);
            File.WriteAllText(@"C:\Users\VISESH\Documents\bl excercise\ObjectOrientedProgram\ObjectOrientedProgram\CommercialDataProcessing\User.json", str);
            ReadStockFile(@"C:\Users\VISESH\Documents\bl excercise\ObjectOrientedProgram\ObjectOrientedProgram\CommercialDataProcessing\User.json");
        }
    }
